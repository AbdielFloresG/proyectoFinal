            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Seccion de tablas, cantidad de veces que se vendio cada juego
                            </div>
                        </div>
                        <div class="card mb-4">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php foreach($resultado as $row) {?>
                                            <?php 
                                                $idCantidadVentas = $row['idTrasaccion'];
                                                $nombreJuegos = $row['idVenta'];
                                                $categoria = $row['idJuego'];
                                                $cantidadVentas = $row['nombreJuego'];
                                                $cantidad = $row['cantidad'];
                                            ?>
 
                                            <tr>
                                                <td><?php echo $idCantidadVentas;?> </td>
                                                <td><?php echo $nombreJuegos;?> </td>
