    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="eliminarJuego" action="../database/eliminarUsuario.php" method="POST">
                    <div class="mb-3" style="display: none;" >
                        <input type="text" id="idUsuarioEliminar" class="form-control" name="id" placeholder="Nombre" required="true" >
